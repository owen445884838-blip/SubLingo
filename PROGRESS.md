...
- All permanent signing variables remain absent by explicit user decision. Alpha 3 must be published as a validation/debug-signed GitHub prerelease and is not suitable for app-store submission. Branch: `chore/api36-16kb-alpha3`.
