...
- Validation-only Release APK: `app/build/outputs/apk/release/app-release-validation.apk`, SHA-256 `b00a7cd6f0ec496a418e6de5de5704da6d0de1008cfe41c5a1dc723e7d3fabae`; v2/v3 signing verified. UTP's uninstall-after-test behavior removed the previously installed Alpha 3 before this validation build was installed, so this device run was a fresh install and did not test in-place data retention. App version remains `0.1.0-alpha.3`; a public release/version increment is still pending.
